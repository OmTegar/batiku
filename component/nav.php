...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2" style="margin-top: 5vh; margin-left: 4vh;">
        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Dewasa<span class="caret"></span></a>
...
<div class="col-xs-2 col-xs-offset-2">
  ...
  <div class="row">
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2" style="margin-top: 2vh; margin-left: 4vh;">
        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Dewasa<span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a data-toggle="pill" href="#pria">Pria</a></li>
              <li><a data-toggle="pill" href="#wanita">Wanita</a></li>
...
<div class="container-fluid kategori">
<div class="row" style="justify-content: center; display: flex; justify-items: center;">
<div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:14vw; height:7vh; padding-top:2vh;" alt="Brand" src="asset/img/Brand1.png"></a>
    </div>
